...
export const llmConfigSchemas = {
  create: z.object({
    ...
    extractionStrictness: z.enum(['strict', 'moderate', 'lenient']).default('strict'),
    extractionPrompt: z.string().max(10000).optional(),
    summaryPrompt: z.string().max(10000).optional(),
  }),
  ...
  update: z.object({
    ...
    extractionPrompt: z.string().max(10000).optional().nullable(),
    summaryPrompt: z.string().max(10000).optional().nullable(),
  }),
